...
export function SearchFilters({ onSearch, onSectorFilter, selectedSector }: SearchFiltersProps) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6" data-testid="search-filters-container">
      {/* Search Bar */}
      <div className="relative mb-6">
        <div className="absolute left-4 top-1/2 transform -translate-y-1/2">
          <Search className="h-5 w-5 text-cyan-500" data-testid="icon-search" />
        </div>
        <Input
          type="text"
        ...
        <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
          <span className="text-xs text-gray-500 bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded" data-testid="badge-shortcut">
            ⌘K
          </span>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          <Button
            ...
            `}
            data-testid="button-filter-all-sectors"
          >
            All Sectors
          </Button>
          {displayedSectors.map((sector) => (
            <Button
              ...
              `}
              data-testid={`button-filter-sector-${sector.id}`}
            >
          ...
          {sectors.length > 6 && !showAllSectors && (
            <Button 
              ...
              data-testid="button-show-more-sectors"
            >
          ...
          {showAllSectors && sectors.length > 6 && (
            <Button 
              ...
              className="border-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800"
              data-testid="button-show-less-sectors"
            >
              Show Less
            </Button>
          )}
      ...
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg p-4 text-white" data-testid="stat-total-elements">
          ...
          <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-4 text-white" data-testid="stat-core-brands">
            <div className="text-2xl font-bold">{stats.coreBrands.toLocaleString()}</div>
            <div className="text-sm opacity-80">Core Brands</div>
          </div>
          <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg p-4 text-white" data-testid="stat-subnodes">
          ...
          <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-lg p-4 text-white" data-testid="stat-sectors">
