...
export default function OmnilevelPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6" data-testid="omnilevel-page">
      {/* Header */}
      <div className="mb-8">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-3" data-testid="title-omnilevel">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <Card data-testid="card-selected-sectors">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Selected Sectors</p>
                  <p className="text-2xl font-bold text-blue-600" data-testid="count-selected">{selectedSectors.length}</p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600" data-testid="count-available">31</p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600" data-testid="completion-percentage">
      ...
      {selectedSectors.length > 0 && (
        <Card className="mb-6" data-testid="selected-sectors-summary">
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button
                ...
                data-testid="button-ai-complete"
              >
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {selectedSectors.map(({ key, data }) => (
                <div key={key} className="p-3 border rounded-lg bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800" data-testid={`selected-sector-${key}`}>
            ...
            {completionStatus === 'complete' && (
              <div className="mt-4 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg" data-testid="completion-success">
      ...
      {/* Footer Information */}
      <Card className="mt-8" data-testid="footer-info">
        <CardHeader>
