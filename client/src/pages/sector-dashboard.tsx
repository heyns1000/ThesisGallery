...
export default function SectorDashboard() {
  ...
  if (sectorLoading || brandsLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center" data-testid="loading-sector-dashboard">
  ...
  if (!sector) {
    return (
      <div className="min-h-screen flex items-center justify-center" data-testid="sector-not-found">
        <div className="text-center">
  ...
  return (
    <div className="p-6" data-testid="sector-dashboard-page">
